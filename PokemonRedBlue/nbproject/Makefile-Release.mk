...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pokemonredblue: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pokemonredblue ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/expGroup.o: expGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/expGroup.o expGroup.cpp
...
${OBJECTDIR}/pokemon.o: pokemon.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pokemon.o pokemon.cpp

${OBJECTDIR}/pokemonParty.o: pokemonParty.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pokemonParty.o pokemonParty.cpp
